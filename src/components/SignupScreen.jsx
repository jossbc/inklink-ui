  ...
  <div className="min-h-screen bg-black_bean-100 flex items-center justify-center p-4">
    <div className="bg-black_bean-500 p-8 rounded-2xl shadow-lg w-full max-w-md border border-auburn-600">
      ...
      <div className="text-center mb-8">
        <div className="w-20 h-20 bg-transparent rounded-full flex items-center justify-center mx-auto mb-4 shadow-md overflow-hidden">
          <img
      ...
      <form className="space-y-4" noValidate>
        <div className="grid grid-cols-2 gap-4">
          <div>
            <label htmlFor="name" className="block text-sm font-medium text-auburn-200 mb-1">Nombre</label>
            <input
              type="text"
              id="name"
              name="name"
          ...
          <div>
            <label htmlFor="lastname" className="block text-sm font-medium text-auburn-200 mb-1">Apellido</label>
            <input
              type="text"
              id="lastname"
              name="lastname"
        ...
        <div>
          <label htmlFor="email" className="block text-sm font-medium text-auburn-200 mb-1">Email</label>
          <input
            type="email"
            id="email"
            name="email"
        ...
        <div>
          <label htmlFor="password" className="block text-sm font-medium text-auburn-200 mb-1">Contraseña</label>
          <input
            type="password"
            id="password"
            name="password"
        ...
        <div>
          <label htmlFor="confirmPassword" className="block text-sm font-medium text-auburn-200 mb-1">Confirmar Contraseña</label>
          <input
            type="password"
            id="confirmPassword"
